...
from utils import HDF5Dataset,CB_loss,patient_aggregation,HDF5Dataset_GAN,HDF5Dataset_Meta

# new model option: https://github.com/Xiyue-Wang/TransPath/blob/main/ctran.py
